...
def main():
    ...
    parser.add_argument("--iter", type=int, default=10000, help="number of iterations to run")
    parser.add_argument(
    ...
    with open("C:/Users/danie/OneDrive/Documents/bird2/data/hitmasks_data.pkl", "rb") as input:
...
def showGameOverScreen(crashInfo):
    ...
    training_score.append((bot.gameCNT, score))
